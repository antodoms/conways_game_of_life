...
RSpec.describe Board do
  ...
  it "returns the list of all neighbouring cells for that cell" do
    ...
    expect(board.get_neighbors(board.get_cell(0,0))).to eq([board.get_cell(1,0), board.get_cell(1,1), board.get_cell(0,1)])
  ...
  it "returns the list of all live neighbouring cells for that cell" do
    ...
    expect(board.get_live_neighbours(board.get_cell(0,0))).to eq([board.get_cell(1,0), board.get_cell(0,1)])
  ...
  it "returns the list of all dead neighbouring cells for that cell" do
    ...
    expect(board.get_dead_neighbours(board.get_cell(0,0))).to eq([board.get_cell(1,1)])
